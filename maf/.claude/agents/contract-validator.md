...
description: Validates integration contracts between domains to prevent integration failures. Specialized for FULL tier Phase 2 (Synthesis) cross-domain validation.
