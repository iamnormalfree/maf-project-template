...
async def main() -> None:
    ...
    async with Client("http://127.0.0.1:8765/mcp/") as client:
        ...
        # Finally run whatever workflow you need. As an example, call the file reservation tool.
        response = await client.call_tool(
            "file_reservation_paths",
            {
                "project_key": "/root/projects/roundtable",
                "agent_name": "OrangePond",
                "paths": ["apps/site/**"],
                "ttl_seconds": 3600,
                "exclusive": True,
                "reason": "File reservation for agent OrangePond"
            },
        )
        print("==> file_reservation_paths result:")
